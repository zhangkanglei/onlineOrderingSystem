	...
	<div class="row clearfix">
		...
		<s:else>
			...
			<tr>
				...
				<td>${allTotal }</td>
				<td>${tableNum }</td>
				<td><a href="orderItem-update?id=${id }">${orderStatus }</a></td>
        ...
        <s:if test="#page.hasFirst">  
            <a href="orderItem-list?pageNow=1"  target="_self">首页</a>  
        </s:if>  
        <s:if test="#page.hasPre">  
            <a href="orderItem-list?pageNow=<s:property value="#page.pageNow-1"/> "  target="_self">上一页</a>  
        </s:if>  
        <s:if test="#page.hasNext">  
             <a  href="orderItem-list?pageNow=<s:property value="#page.pageNow+1" />" target="_self">下一页</a>  
        </s:if>  
         <s:if test="#page.hasLast">  
            <a href="orderItem-list?pageNow=<s:property value="#page.totalPage"/>" onclick="change();return false"  target="_self">尾页</a>  
        </s:if>  
     </td>  
  </tr></span>  	
			</table>
